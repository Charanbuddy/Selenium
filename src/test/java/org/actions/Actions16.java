...
public class Actions16 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement txtSrch = driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']"));
		txtSrch.sendKeys("sd card");

		WebElement clkSrch = driver.findElement(By.xpath("(//input[@type='submit'])[1]"));
		clkSrch.click();
