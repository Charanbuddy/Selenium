...
public class Actions07 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement clkMouse2 = driver.findElement(By.xpath("//div[@title='Oracle']"));
		ab.moveToElement(clkMouse2).perform();
		
		WebElement clkMouse3 = driver.findElement(By.xpath("//span[text()='Oracle SQL and PLSQL Placement Certification Training']"));
