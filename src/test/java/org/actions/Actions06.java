...
public class Actions06 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement clkMouse2 = driver.findElement(By.xpath("//div[@title='Software Testing']"));
		ab.moveToElement(clkMouse2).perform();

		WebElement clkMouse3 = driver.findElement(By.xpath("//span[text()='Selenium Certification Training']"));
