...
public class Actions12 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement clkMouse2 = driver.findElement(By.xpath("(//a[@title='Paint'])[1]"));
		ab.moveToElement(clkMouse2).perform();

		WebElement clkMouse3 = driver.findElement(By.xpath("(//a[@title='Interior Paint'])[1]"));
		ab.moveToElement(clkMouse3).perform();

		WebElement clkMouse4 = driver.findElement(By.xpath("//a[@title='Ceiling Paint']"));
		clkMouse4.click();
